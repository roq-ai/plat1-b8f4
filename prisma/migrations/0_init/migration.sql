...
-- AddForeignKey
ALTER TABLE "license_plate" ADD CONSTRAINT "license_plate_client_id_fkey" FOREIGN KEY ("client_id") REFERENCES "client"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
