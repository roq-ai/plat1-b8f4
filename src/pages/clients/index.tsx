...
export function ClientListPage(props: ClientListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getClients({
        relations: ['user', 'license_plate.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('license_plate', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'license_plate',
          header: 'License Plate',
          accessorKey: 'license_plate',
          cell: ({ row: { original: record } }: any) => record?._count?.license_plate,
        }
      : null,
